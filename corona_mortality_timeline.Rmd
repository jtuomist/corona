...
country <- c("Finland", "Romania", "Sweden","United Kingdom")

plot_ly(
  infective[infective$Country %in% country, ],
...
plot_ly(
  aggregate(infective_us["Infective"], by=infective[c("Date","State")], FUN=function(x) sum(x, na.rm=TRUE)),
...
plot_ly(
  infective_us[infective$State==state, ],
